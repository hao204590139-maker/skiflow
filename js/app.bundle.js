...
(function () {
  ...
  const skiPhase3 = [
    ...
    ],[VID.yt_carve,VID.dy_ski_carve],['搓雪vs卡宾','提前入刃','侧切原理','雪痕判断']),
  ...
  const skiPhase4 = [
    ...
    ],[VID.yt_short,VID.dy_ski_short],['快速换刃','节奏点杖','上身稳定','走廊练习']),
    ...
    ],[VID.yt_mogul,VID.dy_ski_mogul],['吸收伸展','走线选择','拉链线','身体悬挂']),
    ...
    ],[VID.yt_powder,VID.dy_ski_powder],['粉雪站姿','漂浮原理','海豚转弯','双板并拢']),
  ...
  const sbPhase1 = [
    ...
    ],[VID.sb_beginner,VID.sb_bili_beginner,VID.sb_bili_newbie],['装备认知','板型选择','固定器角度','Regular vs Goofy']),
    ...
    ],[VID.sb_beginner,VID.sb_bili_beginner2],['安全摔倒','护具选择','手腕保护','尾骨保护']),
    ...
    ],[VID.sb_bili_beginner,VID.sb_beginner,VID.sb_bili_casi],['侧身站姿','重心居中','视线方向','核心收紧']),
    ...
    ],[VID.sb_beginner,VID.sb_bili_fullseries],['单脚推滑','上坡移动','直滑降','防滑垫']),
    ...
    ],[VID.sb_bili_beginner,VID.sb_beginner,VID.sb_bili_beginner2],['后刃推坡','前刃推坡','落叶飘','刃的微调']),
  ];
  ...
  const sbPhase2 = [
    ...
    ],[VID.sb_turns,VID.sb_bili_turns,VID.sb_bili_casi],['横滑降','J弯','板头转向','滚落线']),
    ...
    ],[VID.sb_turns,VID.sb_bili_turns,VID.sb_bili_beginner2],['换刃','C弯','S弯','卡刃','重心转移']),
    ...
    ],[VID.sb_beginner,VID.sb_bili_casi],['单脚上下缆车','防滑垫使用','下站安全']),
    ...
    ],[VID.sb_turns,VID.sb_bili_huang],['选道策略','速度管理','地形阅读','里程积累']),
  ];
  ...
  const sbPhase3 = [
    ...
    ],[VID.sb_turns,VID.sb_bili_turns,VID.sb_bili_huang],['上下身协调','压力管理','换刃流畅','节奏变化']),
    ...
    ],[VID.sb_carve,VID.sb_bili_carve2],['刃角控制','脚踝微调','搓雪vs切雪']),
    ...
    ],[VID.sb_carve,VID.sb_bili_carve,VID.sb_bili_edge],['刻滑','提前入刃','侧切信任','身体倾斜']),
    ...
    ],[VID.sb_powder,VID.sb_bili_huang],['冰面策略','春雪应对','烂雪滑行','平光技巧']),
    ...
    ],[VID.sb_turns,VID.sb_bili_huang],['短弯控速','分段下滑','心态管理']),
  ];
  ...
  const sbPhase4 = [
    ...
    ],[VID.sb_carve,VID.sb_bili_carve,VID.sb_bili_carve3],['高速刻滑','Euro Carving','回转半径']),
    ...
    ],[VID.sb_turns,VID.sb_bili_huang],['快速换刃','后脚踢转','核心稳定']),
    ...
    ],[VID.sb_powder,VID.sb_bili_huang],['包顶路线','吸收伸展','节奏感']),
    ...
    ],[VID.sb_powder,VID.sb_bili_huang],['重心后移','浮力原理','粉雪板选择']),
    ...
    ],[VID.sb_powder,VID.sb_bili_huang],['视线看空隙','提前规划','安全守则']),
  ];
  ...
  const sbPhase5 = [
    ...
    ],[VID.sb_jump,VID.sb_bili_huang],['直飞','POP起跳','空中姿态','落地吸收']),
    ...
    ],[VID.sb_jump,VID.sb_park,VID.sb_bili_huang],['50-50','Boardslide','180/360','视线引领']),
    ...
    ],[VID.sb_turns,VID.sb_bili_huang],['跳转','推坡安全网','心理控制']),
    ...
    ],[VID.sb_powder,VID.sb_bili_huang],['Splitboard','分离拼合','爬升转换']),
