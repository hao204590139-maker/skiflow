...
(function () {
  ...
  const VID = {
    ...
    sb_bili_beginner2: { videoId: 'BV1ns421w7tz', platform: 'bilibili', channel: '保姆级单板教学', title: '0基础自学单板入门到换刃', language: 'zh' },
    sb_bili_casi: { videoId: 'BV1gTpRz2E7A', platform: 'bilibili', channel: '单板快速入门', title: 'CASI体系单板快速入门', language: 'zh' },
    sb_bili_newbie: { videoId: 'BV1uzbaeBExh', platform: 'bilibili', channel: '新手单板教学', title: '新手单板入门学什么怎么学', language: 'zh' },
    sb_bili_fullseries: { videoId: 'BV1KJ1oYsEUx', platform: 'bilibili', channel: '野鬼单板教学', title: '0基础入门到走刃完整系列', language: 'zh' },
    sb_bili_carve2: { videoId: 'BV1V7yeYvEMY', platform: 'bilibili', channel: '单板走刃教学', title: '0基础到走刃第7集：走刃/刻滑', language: 'zh' },
    sb_bili_huang: { videoId: 'BV1J9wPegEAA', platform: 'bilibili', channel: '黄嘉蓝单板教学', title: '单板滑雪全套教学合集', language: 'zh' },
    ...
    dy_ski_powder: { videoId: '7179034567890123468', platform: 'douyin', channel: '粉雪猎人', title: '双板粉雪技巧详解', language: 'zh' },
    // Bilibili ski videos (replace YouTube)
    bili_ski_parallel2: { videoId: 'BV1dB42167bj', platform: 'bilibili', channel: '双板滑雪教学', title: '学平行要学冰球刹', language: 'zh' },
    bili_ski_steer: { videoId: 'BV16p4y1w72c', platform: 'bilibili', channel: '双板技术教学', title: '双板滑雪技术教学——驱转STEER', language: 'zh' },
    bili_ski_carve: { videoId: 'BV1ue4y1d7bV', platform: 'bilibili', channel: '双板卡宾教学', title: '双板卡宾进阶教学', language: 'zh' },
    bili_ski_carve2: { videoId: 'BV14i4y1r7a7', platform: 'bilibili', channel: '缓坡卡宾', title: '缓坡高立刃卡宾练习', language: 'zh' },
    bili_ski_switch: { videoId: 'BV1x7421R7jp', platform: 'bilibili', channel: '双板倒滑', title: '双板倒滑教学', language: 'zh' },
    bili_ski_kids: { videoId: 'BV1AG41167q7', platform: 'bilibili', channel: '双板儿童入门', title: '双板入门三个小游戏', language: 'zh' },
    bili_ski_beginner_full: { videoId: 'BV1D4yLY1ErN', platform: 'bilibili', channel: '双板入门教程', title: '双板滑雪新手入门到进阶完整流程', language: 'zh' },
    bili_ski_mogul2: { videoId: 'BV11mcwekEyG', platform: 'bilibili', channel: '双板蘑菇教学', title: '双板猫跳/蘑菇入门教学', language: 'zh' },
  };
  ...
  const skiChapters = [
    ...
    ],[VID.bili_equip,VID.bili_ski_beginner_full],['装备认知','滑雪类型','雪道分级','安全装备']),
    ...
    ],[VID.bili_safety,VID.bili_ski_beginner_full],['FIS安全准则','正确摔倒','安全装备','高原适应']),
    ...
    ],[VID.bili_stance,VID.bili_ski_beginner_full],['运动站姿','重心控制','脚踝弯曲','视线方向']),
    ...
    ],[VID.bili_shorpin,VID.bili_snowplow],['犁式站姿','重心转移','腿部发力','连续转弯','控速']),
  ];
  ...
  const skiPhase2 = [
    ...
    ],[VID.bili_parallel,VID.bili_ski_parallel2],['半犁式','收板时机','平行过渡','重心分配']),
    ...
    ],[VID.bili_parallel,VID.bili_ski_parallel2],['平行转弯','上下身分离','点杖','C形弯','立刃']),
    ...
    ],[VID.bili_parallel,VID.bili_ski_parallel2],['实践应用','地形阅读','路线规划','速度管理']),
  ];
  ...
  const skiPhase3 = [
    ...
    ],[VID.bili_intermediate,VID.bili_ski_carve],['上下身分离','反弓','立刃角度','精准转向']),
    ...
    ],[VID.bili_intermediate,VID.bili_ski_carve],['立刃原理','刃角控制','火车轨练习','J弯练习']),
    ...
    ],[VID.bili_ski_carve,VID.bili_ski_carve2],['搓雪vs卡宾','提前入刃','侧切原理','雪痕判断']),
    ...
    ],[VID.bili_intermediate,VID.bili_ski_parallel2],['硬雪技巧','冰面滑行','湿雪应对','平光策略']),
    ...
    ],[VID.bili_ski_parallel2,VID.bili_ski_steer],['短弯控速','侧滑','落叶飘','心理准备']),
  ];
  ...
  const skiPhase4 = [
    ...
    ],[VID.bili_ski_carve,VID.bili_ski_carve2],['高立刃','Crossover','Crossunder','反弹利用']),
    ...
    ],[VID.bili_ski_steer],['快速换刃','节奏点杖','上身稳定','走廊练习']),
    ...
    ],[VID.bili_ski_mogul2],['吸收伸展','走线选择','拉链线','身体悬挂']),
    ...
    ],[VID.bili_ski_beginner_full],['粉雪站姿','漂浮原理','海豚转弯','双板并拢']),
    ...
    ],[VID.bili_intermediate,VID.bili_ski_parallel2],['地形阅读','树林滑行','安全意识','结伴原则']),
  ];
  ...
  const skiPhase5 = [
    ...
    ],[VID.bili_ski_carve],['大回转','走线策略','提前入刃','高压对抗']),
    ...
    ],[VID.bili_ski_steer],['跳转','冰镐制动','No-Fall Zone','风险评估']),
    ...
    ],[VID.bili_ski_switch],['POP起跳','空中姿态','落地吸收','旋转入门']),
    ...
    ],[VID.bili_ski_beginner_full],['AT装备','止滑带','爬升技巧','路线规划']),
    ...
    ],[VID.bili_safety,VID.bili_ski_beginner_full],['雪崩三件套','信标搜索','地形识别','雪崩预报']),
  ];
  ...
  const sbPhase5 = [
    ...
    ],[VID.bili_safety,VID.bili_ski_beginner_full],['雪崩三件套','信标搜索','黄金15分钟','预防为主']),
  ];
  ...
  function createVideoItem(video) {
    ...
    var platformLabel = video.platform === 'bilibili' ? 'B站' : video.platform === 'douyin' ? '抖音' : video.platform === 'xiaohongshu' ? '小红书' : 'YouTube';
  ...
  function loadVideo(container, video) {
    ...
    if (video.platform === 'bilibili') {
      ...
      const xLink = createElement('a', {
        href: video.url || 'https://www.xiaohongshu.com/explore/' + video.videoId,
        target: '_blank', rel: 'noopener',
        style: 'position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;color:#fff;text-decoration:none;gap:12px;cursor:pointer;',
      });
      xLink.appendChild(createElement('span', { style: 'font-size:3rem;' }, '📕'));
      xLink.appendChild(createElement('span', { style: 'font-size:1rem;font-weight:600;' }, '在小红书中观看'));
      xLink.appendChild(createElement('span', { style: 'font-size:0.8rem;opacity:0.7;' }, video.title || '点击跳转小红书查看教学视频'));
